...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        if ($stmt->execute()) {
            $success = "Heslo bolo úspešne zmenené! <a href='login.php'>Prihlásiť sa</a>";
            unset($_SESSION["reset_user_id"]); // Vymažeme session
        } else {
            $errors = "Chyba pri zmene hesla!";
        }
    }
}
?>
...
<head>
    ...
    <title>WEBTE2 - Nastavenie nového hesla</title>
